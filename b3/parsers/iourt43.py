...
class Iourt43Client(Client):
    ...
    def auth(self):
        """
        The b3.clients.Client.auth method needs to be changed to fit the UrT4.2 (and later) authentication scheme.
        In UrT4.2 (and later) :
...
class Iourt43Parser(Iourt41Parser):
    ...
    def OnClientuserinfo(self, action, data, match=None):
        ...
        if bclient:
            ...
            if client:
                ...
                # TODO: is this bug fixed in 4.3?
                # https://github.com/BigBrotherBot/big-brother-bot/issues/346
    ...
    def patch_Clients():
        ...
        def newClient(self, cid, **kwargs):
            """
            Patch the newClient method in the Clients class to handle UrT 4.2 (and later) specific client instances.
            """
